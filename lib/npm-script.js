...
exports.getSpawnOptions = function getNPMSpawnOptions(dir, lifecycle, options, callback) {
  ...
  findPackage(fs, dir, function (err, packageFile) {
    ...
    fs.readFile(packageFile, function (err, packageContents) {
      ...
      //
      getBasicSpawnOptions(fs, lifecycle, packageJSON, root, dir, options.defaultScript, options.raw, function (err, spawnOptions) {
        if (err) {
          callback(err, null);
          return;
        }
...
function getBasicSpawnOptions(fs, lifecycle, packageJSON, root, cwd, defaultScript, raw, callback) {
